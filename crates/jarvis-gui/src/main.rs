...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            tauri_commands::save_custom_commands,
            tauri_commands::get_commands_count,
            tauri_commands::get_commands_list,
            tauri_commands::get_custom_sounds_dir,
            tauri_commands::import_custom_sound,
            ...
            tauri_commands::is_windows_autostart,
            tauri_commands::set_windows_autostart,
        ])
