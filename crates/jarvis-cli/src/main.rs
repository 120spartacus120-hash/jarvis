...
use jarvis_core::{COMMANDS_LIST, DB, JCommandsList, commands, config, custom_commands, db, intent, set_commands_list};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("    Loaded custom browser commands");
    println!("\n[*] Initializing intent classifier...");
    match intent::init(&COMMANDS_LIST.read()).await {
